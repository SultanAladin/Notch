        ...
        <div className="absolute bottom-[35px] left-0 right-0 h-[2000px] bg-[#0A0A0B]">
          ...
          >
            <motion.div
              ...
              animate={{
                maxWidth: activeSetting ? 840 : 420,
                height: activeSetting ? 600 : 480
              }}
              transition={{ type: "spring", bounce: 0.15, duration: 0.5 }}
            >
              <AnimatePresence mode="wait">
                {!showSettings && !activeSetting && (
                  <motion.div
                    key="control-center"
                ...
                {activeSetting === "displaySettings" && (
                  <motion.div
                    ...
                    transition={{ duration: 0.2 }}
                    className="absolute inset-0 flex flex-col bg-[#161415] rounded-[32px] overflow-hidden border border-white/5 shadow-2xl"
                    onPointerDown={(e) => e.stopPropagation()}
                  >
                    <SettingsModal onClose={() => setActiveSetting(null)} />
                  </motion.div>
                )}
                
                {activeSetting === "workspaceSettings" && (
                  <motion.div
                    ...
                    onPointerDown={(e) => e.stopPropagation()}
                  >
                    <WorkspaceSettingsModal onClose={() => setActiveSetting(null)} />
                  </motion.div>
                )}

                {activeSetting === "inputSettings" && (
                  <motion.div
                    key="inputSettings"
                    initial={{ opacity: 0, x: 40, scale: 0.95 }}
                    animate={{ opacity: 1, x: 0, scale: 1 }}
                    ...
                    onPointerDown={(e) => e.stopPropagation()}
                  >
                    <InputSettingsModal onClose={() => setActiveSetting(null)} />
                  </motion.div>
                )}

                {activeSetting === "telemetrySettings" && (
                  <motion.div
                    ...
                    onPointerDown={(e) => e.stopPropagation()}
                  >
                    <TelemetrySettingsModal onClose={() => setActiveSetting(null)} />
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
